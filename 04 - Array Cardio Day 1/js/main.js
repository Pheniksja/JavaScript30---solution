...
// const newTabFifteen = inventors.filter(function(inventors) {
//     if (inventors.year >= 1499 && inventors.year < 1600) {
//         return true;
//     }
// })
// console.table(newTabFifteen)


// // arrow function
    const newTabFifteen = inventors.filter(inventor =>
...
// // arrow function and ternary operator
    const sortInventors2 = inventors.sort((a,b) => a.year > b.year ? 1 : -1)[1];
    console.table(sortInventors2);
//
//
...
// 5. Sort the inventors by years lived
    ...
    const yearsLived = inventors.sort(function(a,b) {
        const totalA = a.passed-a.year;
        const totalB = b.passed-b.year;
...
const alphabeticList = people.sort (function (a,b) {
    return a > b ? 1 : -1;
});
